#ifndef CUSTOM_MPL_SEARCH_ALGORITHMS_DETAIL_ASTARDENSEIDS_TPP
#define CUSTOM_MPL_SEARCH_ALGORITHMS_DETAIL_ASTARDENSEIDS_TPP
...
auto astar_dense_ids(const Gid &G, int s, int t, const Hid &h,
                     PQ open) -> custom_mpl::search::core::SearchResult<int> {
